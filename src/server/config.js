...
nconf.defaults({
  ...
  apiConfig: {
    baseUrl: 'http://api-dev.snabb.io/api', //https://snabb-api-mock.herokuapp.com/api/v1',
    clientId: '98niOFu1RRW0xw5O9uqhhrd9eYVvyyzgM4pozeQN', //https://snabb-api-mock.herokuapp.com/api/v1',
  },
});
