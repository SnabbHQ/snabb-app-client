...
import {
  ...
  updateBillingDetails } from '../../actions';
import {
  DEFAULT_CITY,
  CITIES } from '../../constants';
import configuration from '../../../configuration';
import Card from '../../components/Card';
import CreditCardsTable from '../../components/CreditCardsTable';
import CreditCardForm from '../../components/CreditCardForm';
import BillingDetailsForm from '../../components/BillingDetailsForm';
import * as creditCardHelper from '../../lib/creditCard.js';
...
function mapStateToProps(state) {
  ...
  const topUpLink = `${configuration.stuartDashboardUrl}/wallets/${wallet.id}/topups/new?access_token=${token}`;
