    ...
    return (
      <View style={styles.container}>
        <View style={{ flex: 10 }}>
          ...
          >
            <View style={styles.slide1}>
              <FitImage
                style={styles.image}
                source={require('./img/request_pickup.png')}
                originalWidth={640}
                originalHeight={1136}
              />
            </View>
            <View style={styles.slide2}>
              <FitImage
                style={styles.image}
                source={require('./img/transport_selection.png')}
                originalWidth={640}
                originalHeight={1136}
              />
            </View>
        ...
        <View style={{ flex: 1, flexDirection: 'row' }}>
          <Button
            style={styles.buttonRegister} textStyle={{ color: '#F9F9F9' }}
          ...
          <Button
            style={styles.buttonLogin} textStyle={{ color: '#00D5D5' }}
